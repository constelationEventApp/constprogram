...
public class FavoriteProgramActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favorite_program);
    ...
    private void setUpRecyclerView() {
        ...
        RecyclerView recyclerView = findViewById(R.id.programListFavorite);
        ...
        adapter.setOnItemClickListener(new ProgramAdapter.ClickListener() {
            ...
            public void onItemClick(int position, View v) {
                ...
                Toast.makeText(FavoriteProgramActivity.this, identifiant.getText(), Toast.LENGTH_SHORT).show();
            }
